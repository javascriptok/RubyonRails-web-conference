...
class Role < ApplicationRecord
    ...
    def self.create_default_roles(provider)
        Role.create(name: "user", provider: provider, priority: 1, colour: "#868e96", title: 'User')
            .update_all_role_permissions(can_create_rooms: true)
        Role.create(name: "admin", provider: provider, priority: 0, colour: "#f1c40f", title: 'Admin')
        ...
        Role.create(name: "pending", provider: provider, priority: -1, colour: "#17a2b8", title: 'Pending').update_all_role_permissions
        Role.create(name: "denied", provider: provider, priority: -2, colour: "#343a40", title: 'Denied').update_all_role_permissions
        Role.create(name: "super_admin", provider: provider, priority: -3, colour: "#cd201f", title: 'Super Admin')
            .update_all_role_permissions(can_create_rooms: true,
